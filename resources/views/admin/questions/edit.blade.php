<x-app-layout>
	<x-slot name="header">{{$question->question}} Adlı Soruyu Güncelle</x-slot>
	<div class="card">
		<div class="card-body">
			<form method="POST" action="{{route('questions.update',[$question->quiz_id,$question->id])}}" enctype="multipart/form-data">				
				...
				<div class="form-group">
					...
					<img src="{{asset($question->image)}}" style="max-width: 500px;">
					</a>
					@endif
				...
				<div class="row">
					...
					<div class="form-group" style="width: 150px;">
						<select name="correct_answer" class="form-control">
							...
							<option @if($question->correct_answer==='answer4') selected @endif alue="answer4">4.Cevap</option>
